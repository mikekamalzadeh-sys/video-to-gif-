...
#
# نکته درباره‌ی «Gram»: توکنی با همین اسم توسط تلگرام برنامه‌ریزی شده بود،
# ولی هرگز عرضه نشد و پروژه به «تون‌کوین (TON)» توسط جامعه‌ی توسعه‌دهنده‌ها
# تبدیل شد. چون توکنی به اسم «Gram» در هیچ صرافی‌ای معامله نمی‌شه، به‌جاش
# TON (جانشین واقعی‌ش) رو اضافه کردم.
...
ASSETS = {
    ...
    "ton": {
        "title": "تون‌کوین (Gram سابق)", "short": "تون‌کوین", "emoji": "💎",
        "nobitex_symbol": "ton-rls",
    },
    "sol": {
